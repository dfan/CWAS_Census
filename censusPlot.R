...
setwd('/Users/dfan/Dropbox/Research\ Lab\ Projects/Undergraduate/Harvard-MIT\ 2016/Code/CWAS_PartTwo')
df$value <- as.numeric(as.character(data$medianincome))
png('medianIncome.png', units="px", width=1600, height=1600, res=150)
...
png('population.png', units="px", width=1600, height=1600, res=150)
...
png('blackFrac.png', units="px", width=1600, height=1600, res=150)
...
png('whiteFrac.png', units="px", width=1600, height=1600, res=150)
